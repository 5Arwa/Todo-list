      ...
      ?>
        <div class="m-2 py-3">
          <div class="show-to-do">
            ...
            <?php endif;
            while($doing=$stm->fetch(PDO::FETCH_ASSOC)):
      ...
      <div class="m-2 py-3">
        <div class="show-to-do">
          ...
          <?php endif;
            ...
            while($done=$stm->fetch(PDO::FETCH_ASSOC)):
            
          ?>
          <div class="alert alert-warning p-2">
            <a href="handle/delete.php?id=<?php echo $done['id']?>" onclick="return confirm('are your sure')"  class="remove-to-do text-dark d-flex justify-content-end">X</a>                                                                
